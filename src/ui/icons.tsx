...
function Svg({
  ...
  smooth,
  children,
}: IconProps & { smooth?: boolean; children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 16 16"
      fill="currentColor"
      shapeRendering={smooth ? "auto" : "crispEdges"}
...
/**
 * GitHub's own mark, which is the one people look for when they want the
 * source. Curved, so it opts out of the pixel grid the rest of the set is on.
 */
